...
import { getTasksByRole, completeTask } from '../../api/apiHandler';
...
const TaskCard = ({ task, index, isOpen, onToggle, onMarkDone, onNavigate, completing }) => {
      ...
      >
        ...
        >
          {isDone ? (
            ...
            <ClipboardList size={18} className="text-indigo-600" strokeWidth={2.5} />
          )}
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-slate-500 font-bold mt-1">{task.patientName}</p>
          ...
          <div className="grid grid-cols-2 gap-4 text-xs">
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-slate-900 font-black mt-0.5">{formattedDate}</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-slate-900 font-black mt-0.5">{task.assignedToRole}</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <Stethoscope size={13} className="text-slate-400 mt-0.5 flex-shrink-0" />
              <div>
                <span className="font-bold text-slate-400 uppercase tracking-widest text-[9px]">
                  Task ID
                </span>
...
export default function TasksPage() {
  ...
  const filteredTasks = tasks.filter((t) => {
    ...
    const matchRole =
      !roleFilter || t.assignedToRole.toLowerCase() === roleFilter.toLowerCase();
      ...
      <div className="mx-auto w-full max-w-4xl">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white rounded-xl border-2 border-dashed border-slate-200 text-slate-400 font-black uppercase tracking-widest text-sm">
            {activeFilter === 'Completed' ? '✓ No completed tasks' : 'No tasks found'}
          </div>
        ) : (
