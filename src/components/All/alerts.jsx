...
import { getAlertsByRole, markAlertRead } from '../../api/apiHandler.js';
import { SearchContext } from './Layout.jsx';
import { useNavigate } from 'react-router-dom';
import { useData } from './IContext.jsx';
import PatientDetailsModal from '../Reception/PatientDetailsModal.jsx';
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div>
            ...
            <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mt-1">
              Notifications inbox · {filteredAlerts.length}{' '}
              action
