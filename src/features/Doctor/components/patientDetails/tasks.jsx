              ...
              {doctorTasks.length > 0 ? (
                doctorTasks.map((t) => {
                  ...
                  return (
                    <div
                      key={t.id}
                      className="group p-5 rounded-3xl bg-white hover:shadow-xl hover:shadow-blue-900/5 transition-all duration-300 flex justify-between items-center gap-6"
                    >
            ...
            <div className="space-y-3">
              {nurseTasks.length > 0 ? (
                nurseTasks.map((t) => (
                  <div
                    key={t.id}
                    className="p-5 rounded-3xl bg-slate-100/50 flex justify-between items-center group"
                  >
                    <div className="flex-1">
